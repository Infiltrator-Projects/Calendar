...
The current unreleased `main` contains post-1.0.17 documentation and correctness work. This ledger deliberately makes no claim that those unreleased commits have completed a separately recorded manual Cinnamon/location qualification.
