...
Read `docs/README.md` for document authority. Architecture belongs in `docs/ARCHITECTURE.md`; rationale in `docs/DESIGN.md`; durable choices in `docs/DECISIONS.md`; direction in `docs/ROADMAP.md`; validation policy in `docs/VALIDATION.md`; exact-source environment-dependent observations in `docs/QUALIFICATION.md`; chronology/clock/astronomy provenance and continuation rules in `docs/MODELS.md`; and cross-platform representation, language and compatibility boundaries in `docs/PORTABILITY.md`.
