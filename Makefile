...
INFILTRATR_COMMON_COMMIT := 0f458a7145f3a996ff19f11bf9d0893b91ae5cbb
INFILTRATR_COMMON_VERSION := 1.18.0
...
validate-js: validate-settings-generated
	...
	@python3 -c 'from pathlib import Path; p=Path("$(APPLET_SRC_DIR)/settings.py"); compile(p.read_text(encoding="utf-8"), str(p), "exec")'
...
install: all
	...
	install -Dm644 LICENSE \
		"$(DESTDIR)$(PREFIX)/share/licenses/calendar-plus/LICENSE"
